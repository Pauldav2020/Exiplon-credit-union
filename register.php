        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-container">
                ...
                <select name="type" id="type" value="<?=$type?>" required  >
                    ...
                    <option value="current" <?php echo(isset($_POST['type']) && $_POST['type'] == "current") ? "selected" : "";?>>Checking Account</option>
                    <option value="savings" <?php echo(isset($_POST['type']) && $_POST['type'] == "savings") ? "selected" : "";?>>Savings Account</option>
                    <option value="loan" <?php echo(isset($_POST['type']) && $_POST['type'] == "loan") ? "selected" : "";?>>Loan Account</option>
                </select>
                <select name="currencies" value="<?=$curr?>">
                    <option value="">Select Currency</option>
                    <option value="$" <?php echo(isset($_POST['currencies']) && $_POST['currencies'] == "$") ? "selected" : "";?>>Dollar</option>
                    <option value="€" <?php echo(isset($_POST['currencies']) && $_POST['currencies'] == "€") ? "selected" : "";?>>Euro</option>
                    <option value="£" <?php echo(isset($_POST['currencies']) && $_POST['currencies'] == "£") ? "selected" : "";?>>Pound</option>
                </select>
