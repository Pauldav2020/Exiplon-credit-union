...
<head>
    ...
    <title>EXIPLON FEDERAL CREDIT UNION</title>
                    ...
                    <div class="image-container">
                            ...
                            if ($imgUploaded == "NULL") { ?>
                                <div class="images" style="margin-right:20px">
                                    ...
                                    <span class="material-symbols-outlined" style="width: 70px; height:70px;border-radius: 100%; background-color: #ddd; padding: 10px 15px 0 0;font-size: 40px; margin-left: 45px">person</span>
                                    <!-- <i class="fa-solid fa-camera" ></i> -->
                                    <span class="material-symbols-outlined" id="upted" onclick="openFile()" style="margin-left: 30px;">photo_camera</span>
