...
<div class="account-info">
    <div class="grid-container">
        ...
        <div class="col large">
            ...
            <div>
                <hr>
                <button><a href="./statement.php" style="text-decoration: none; color: white">bank transfer </a></button>
            </div>
        </div>
        <div class="col large">
            ...
            <div>
                ...
                <hr>
                <button><a href="./statement.php" style="text-decoration: none; color: white">view statement</a></button>
            </div>
        </div>
