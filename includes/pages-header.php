...
<head>
    ...
    <title>WELCOME TO EXIPLON FEDERAL CREDIT UNION</title>
</head>
<body id="body1">
    <header>
        <nav>
            <div class="navigation-bar">
                <div class="bank-info">
                    <ul class="phone">
                         <li class="phone"><a href="tel:+17441">(+44) 908</a></li> 
                        <li class="email"><a href="mailto:support@exiploncu.com">support@exiploncu.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="navigation-list">
                <div class="list-container">
                    <div class="brand-logo" style="cursor: pointer!important;">
                        <a href="index"  ><img src="./cap-asset/img/fedlog.png" alt=""></a>
