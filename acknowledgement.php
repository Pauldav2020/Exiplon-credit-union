...
<head>
    ...
    <title>Exiplon Credit Union</title>
    <style>
        .bank {
            text-align:center;
            margin: 50px 0;
...
<body>
    <div class="container">
        <div class="row">
            <div class="acknowledge-cont  shadow-lg bg-light mx-auto w-75 p-4 mt-5">
                ...
                <div class="copyright mt-4">
                    <p>Copyright &copy 2020 <a href="index">Exiplon Credit Union</a> All rights reserved</p>
                </div>
        ...
        <div class="success-container mx-auto shadow-lg bg-light p-4 w-75" id="success-cont">
            ...
            <div class="address">
                <h4>EXIPLON FEDERAL CREDIT UNION </h4>
                <p>Glasgow City Center, UK</p>
            </div>
            <hr>
